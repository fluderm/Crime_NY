...
document.addEventListener("change", function(event) {
  ...
  var sliderContainer = d3.select("div#slider");

  var countyDropdown = sliderContainer.append("select")
    .attr("id", "countyDropdown")
    .attr("multiple", true)  // Allow multiple selections
    .style("position", "absolute")
    .style("top", "520px")  // Adjust the top position as needed
    .style("left", "60px") // Adjust the left position as needed
    .selectAll("option")
    .data(counties)
    .enter()
    .append("option")
  ...
  var yearRange = sliderContainer.append("input")
    ...
    .style("position", "absolute")
    .style("top", "550px")  // Adjust the top position as needed
    .style("left", "300px") // Adjust the left position as needed
    .on("input", function() {
  ...
  .attr("font-size", 10)
  .style("position", "absolute")
  .style("top", "600px")  // Adjust the top position as needed
  .style("left", "0px") // Adjust the left position as needed
  ...
  .attr("font-size", 10)
  .style("position", "absolute")
  .style("top", "580px")  // Adjust the top position as needed
  .style("left", "305px") // Adjust the left position as needed
  .attr("font-weight", "bold")
