...
check_result <- county_total_entries %>%
  group_by(Year, County) %>%
  summarise(Sum_Other_Entries = sum(Index.Total)) %>%
  left_join(county_total_entries, by = c("Year", "County")) %>%
...
#shapefile=readOGR("shapefiles","nyu_2451_34490.shp")
